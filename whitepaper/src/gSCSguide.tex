...
\title{{ Open Automatic Design Management System} \break  }


\author{A.A Zemskov$^{\rm a}$$^{\ast}$\thanks{$^\ast$Corresponding author. Email: latex.helpdesk@tandf.co.uk
...
Germany}}\\\received{v0.1 released January 2018} }
